 ...
 *   are negative). This arm is machine-generated by the lossless parse
 *   (`utils/LosslessJson.ts`), so unlike the free-text `assertField`
 *   checks its *content* is part of the schema — any other string means
