 ...
 * (`utils/LosslessJson.ts`): an ordinary `number` when small enough to be
 * exact, a decimal `string` when the wire value exceeds what an IEEE-754
 * double can represent (2^53 — live mainnet balances already do; see #136).
